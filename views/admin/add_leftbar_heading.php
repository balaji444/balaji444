...
$this->title = "Add Leftbar Headings";
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-8 col-md-6 col-sm-6">
                                    <h2 class="mb-0 mt-0">Add Leftbar Headings</h2>
                                </div><!-- end col-->
                            ...
                            <?php } ?>
                            <div class="col-lg-6">
                            <form class="form-horizontal" name="EntryForm" action="/sathsang/web/admin/add-leftbar-heading" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-8 col-xl-9">
                                            <input type="text" class="form-control" required id="heading_name" name="heading_name">
                                        </div>
                                    </div>
